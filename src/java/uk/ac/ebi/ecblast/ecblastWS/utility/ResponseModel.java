...
public class ResponseModel extends APIResponse {
    ...
    public void setTargetMappedText(String targetMappedText) {
        this.targetMappedText = targetMappedText;
    }

    public String getQueryMappedText() {
        return queryMappedText;
    }

    public void setQueryMappedText(String queryMappedText) {
        this.queryMappedText = queryMappedText;
    }
