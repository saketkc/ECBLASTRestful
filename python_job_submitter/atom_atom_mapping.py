...
import os
import ntpath
__atom_atom_mapping_cmd_line__ = "/nfs/research2/thornton/www/databases/cgi-bin/ecblast/jdk/jre/bin/java -Xmx10G  -jar /nfs/research2/thornton/www/databases/cgi-bin/ecblast/jar/RXNDecoder.jar -g -j AAM -f BOTH"
